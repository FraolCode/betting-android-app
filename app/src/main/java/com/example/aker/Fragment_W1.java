...
public class Fragment_W1 extends Fragment {
     ...
     * @return A new instance of fragment Fragment_W1.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_W1 newInstance(String param1, String param2) {
        Fragment_W1 fragment = new Fragment_W1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment__w1, container, false);
    ...
    public void profile() {
        DatabaseReference redd = FirebaseDatabase.getInstance().getReference().child("winners").child("birr1");
